(function ($) {
  ...
  let pinId = "";
  const applicationId = "E77087D54051CC84ADA549A4D2246124";
  const messageId = "9A7FD94B1FB0E7AAB8280DB88F92CBB1";
...
//alert(data);return false;
    ...
    function login_function() {
      ...
      if (mode == 1 || mode == '1') { //provider login
        ...
        $.ajax({
          ...
          headers: {
            "Authorization": "App 6b098bf9679bfcaf632dadd0c08c8019-161ac1f0-3b79-49bd-a560-9f17b8736528",
    ...
    function check_login_otp() {
      ...
      if (mode == 1) { //provider
        ...
        $.ajax({
          type: "POST",
          url: `https://6jz9n8.api.infobip.com/2fa/2/pin/${pinId}/verify`,
          headers: {
            "Authorization": "App 6b098bf9679bfcaf632dadd0c08c8019-161ac1f0-3b79-49bd-a560-9f17b8736528",
            "Content-Type": "application/json",
            "Accept": "application/json"
          },
          data: JSON.stringify({pin: otp}),
          dataType: "json",
          success: function (data) {
            console.log(data)
            if (data.verified) {
              ...
              var settings = {
                // url: `${base_url}get_user_details_after_otp_check`,
                url: base_url + "user/login/get_user_details_after_otp_check",
                method: "POST",
                data: {
                  mobileno: mobile,
                  country_code: c_code,
