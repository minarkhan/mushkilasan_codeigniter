  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-xl-9 col-md-8">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="<?= base_url() ?>user/Dashboard/paytab_payment" method="get" id="paytab_payment">
                  <div class="form-group">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" maxlength="10" class="form-control isNumber" name="wallet_amt" id="wallet_amt"
                             placeholder="00.00">
                  ...
                  <ul class="list-inline mb-0">
                    <li class="line-inline-item mb-0 d-inline-block">
                      <a href="javascript:;" data-amount="50"
                         class="updatebtn add_wallet_value"><?= currency_conversion($user_currency_code); ?>50</a>
                    </li>
                    <li class="line-inline-item mb-0 d-inline-block">
                      <a href="javascript:;" data-amount="100"
                         class="updatebtn add_wallet_value"><?= currency_conversion($user_currency_code); ?>100</a>
                    </li>
                    <li class="line-inline-item mb-0 d-inline-block">
                      <a href="javascript:;" data-amount="150"
                         class="updatebtn add_wallet_value"><?= currency_conversion($user_currency_code); ?>150</a>
                    </li>
                  </ul>
                </div>
                <div class="container">
                ...
                <input type="hidden" id="pincode"
                       value="<?= (!empty($user_details['pincode'])) ? $user_details['pincode'] : "60652"; ?>">
                <input type="hidden" id="address"
                       value="<?= (!empty($user_details['address'])) ? $user_details['address'] : "1234 Main St."; ?>">
                <input
                  type="hidden" id="city" value="<?= (!empty($city)) ? $city : "Chicago"; ?>">

                <a href="javascript:void(0);" id="stripe_wallet" class="btn btn-primary btn-block withdraw-btn">Add to
                  Wallet</a>
        ...
        <form method="POST" action="https://benefitpay.mushkilasan.com/benefitpay" id="benefitpay_form">
          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
                 value="<?php echo $this->security->get_csrf_hash(); ?>"/>
          <input type="hidden" name="amount" value="" id=benefitpay_amount">
          <input type="hidden" name="payload_nonce" value="" id="benefitpay_nonce">
          <input type="hidden" name="orderID" value="" id="orderID">
        </form>
